...
class _GamePageState extends State<GamePage> {
  ...
  void didChangeDependencies() {
    ...
    countLetter = myLocale == Locale('en', 'US') ? 26 : 32;
    startCodeLetter = myLocale == Locale('en', 'US') ? 65 : 1040;
  ...
  Future<String> getRandomWord(var local) async {
    ...
    Widget build(BuildContext context) {
      return Scaffold(
        appBar: AppBar(
          title: Text(myLocale == Locale('en', 'US') ? 'Hangman' : 'Виселица'),
        ),
        body: Container(
          ...
          child: Center(
            child: SingleChildScrollView(
              child: Column(
                ...
                children: <Widget>[
                  if (currParts == 0) Image.asset(
                    'image/android_hangman_gallows.png', height: 285,
                    width: 230,
                    fit: BoxFit.cover,),
                  if (currParts == 1) Image.asset(
                    'image/android_hangman_head.png',height: 285,
                    width: 275,
                    fit: BoxFit.cover,),
                  if (currParts == 2) Image.asset(
                      'image/android_hangman_body.png', height: 285,
                      width: 275,
                      fit: BoxFit.cover),
                  if (currParts == 3) Image.asset(
                      'image/android_hangman_arm1.png', height: 285,
                      width: 275,
                      fit: BoxFit.cover),
                  if (currParts == 4) Image.asset(
                      'image/android_hangman_arm2.png', height: 285,
                      width: 275,
                      fit: BoxFit.cover),
                  if (currParts == 5) Image.asset(
                      'image/android_hangman_leg1.png', height: 285,
                      width: 275,
                      fit: BoxFit.cover),
                  if (currParts == 6) Image.asset(
                      'image/android_hangman_leg2.png',key: Key('keyAt'), height: 285,
                      width: 275,
                      fit: BoxFit.cover),
                  SizedBox(
                      height: 70,
